...
public class MH_nexus_spawnpoint {
    private final KPS8x9M2gamePlugin plg;
    private final MHCommand cmd;
    private final MHGame mhGame;

    public MH_nexus_spawnpoint(KPS8x9M2gamePlugin plg,MHCommand cmd){
        this.plg=plg;
        this.cmd=cmd;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        loc.setPitch(0);
        loc.setYaw(0);
        mhGame.setNexus_loc(loc);
        sender.sendMessage("ネクサスのスポーン位置を設定しました");
